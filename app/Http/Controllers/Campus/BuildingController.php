...
class BuildingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'CSU_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:2048',
            'FIRE_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:2048',
            'OCCUPANCY_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:2048',
            'LGU_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:2048',
            // Basic Information
