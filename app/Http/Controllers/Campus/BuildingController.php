...
class BuildingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'CSU_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:5120',
            'FIRE_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:5120',
            'OCCUPANCY_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:5120',
            'LGU_cert' => 'required|file|mimes:pdf,jpeg,png,jpg|max:5120',
            // Basic Information
    ...
    public function update(Request $request, Building $building)
    {
        try {
            $validated = $request->validate([
                ...
                'college_office_assigned' => 'nullable|string',
                'completed_at' => 'nullable|date',
                'CSU_cert' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
                'FIRE_cert' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
                'OCCUPANCY_cert' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
