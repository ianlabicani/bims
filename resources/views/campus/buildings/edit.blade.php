...
@section('campus-content')
    ...
    <div class="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
        ...
        <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-6 overflow-x-auto">
            ...
            <span class="text-gray-300">/</span>
            <span class="text-gray-900 font-medium whitespace-nowrap">Edit</span>
        </nav>
        ...
        <!-- Form -->
        <form action="{{ route('campus.buildings.update', $building) }}"
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="type" id="type"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('type', $building->type ?? '') }}" placeholder="e.g., Classroom, Office, Laboratory">
                                    @error('type')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="department_agency" id="department_agency"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('department_agency', $building->department_agency ?? '') }}">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="college_office_assigned" id="college_office_assigned"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('college_office_assigned', $building->college_office_assigned ?? '') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="address" id="address"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                    value="{{ old('address', $building->address ?? '') }}" placeholder="Street address">
                                @error('address')
                                    <p class="text-red-500 text-sm mt-2"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                    placeholder="Building description...">{{ old('description', $building->description ?? '') }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-2"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="floor_area" id="floor_area"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('floor_area', $building->floor_area ?? '') }}">
                                    @error('floor_area')
                                        <p class="text-red-500 text-sm mt-2"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="number_of_rooms" id="number_of_rooms" min="0"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('number_of_rooms', $building->number_of_rooms ?? '') }}">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="number_of_CRs" id="number_of_CRs" min="0"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('number_of_CRs', $building->number_of_CRs ?? '') }}">
                                    @error('number_of_CRs')
                                        <p class="text-red-500 text-sm mt-2"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <select name="classification" id="classification"
                                    ...
                                    <option value="concrete" {{ old('classification', $building->classification ?? '') === 'concrete' ? 'selected' : '' }}>Concrete</option>
                                    <option value="semi-concrete" {{ old('classification', $building->classification ?? '') === 'semi-concrete' ? 'selected' : '' }}>Semi-concrete</option>
                                    <option value="wooden" {{ old('classification', $building->classification ?? '') === 'wooden' ? 'selected' : '' }}>Wooden</option>
                                    <option value="other" {{ old('classification', $building->classification ?? '') === 'other' ? 'selected' : '' }}>Others (specify)</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="physical_condition" id="physical_condition"
                                    ...
                                    <option value="good" {{ old('physical_condition', $building->physical_condition ?? '') === 'good' ? 'selected' : '' }}>Good</option>
                                    <option value="needs repair" {{ old('physical_condition', $building->physical_condition ?? '') === 'needs repair' ? 'selected' : '' }}>Needs Repair</option>
                                    <option value="needs rehabilitation" {{ old('physical_condition', $building->physical_condition ?? '') === 'needs rehabilitation' ? 'selected' : '' }}>Needs Rehabilitation</option>
                                    <option value="condemnable" {{ old('physical_condition', $building->physical_condition ?? '') === 'condemnable' ? 'selected' : '' }}>Condemnable</option>
                                </select>
                            ...
                            <div>
                                ...
                                <textarea name="condition_description" id="condition_description" rows="3"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                    placeholder="Describe the current condition...">{{ old('condition_description', $building->condition_description ?? '') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="location_street" id="location_street"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('location_street', $building->location_street ?? '') }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="location_brgy" id="location_brgy"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('location_brgy', $building->location_brgy ?? '') }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="location_municipality" id="location_municipality"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('location_municipality', $building->location_municipality ?? '') }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="location_province" id="location_province"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('location_province', $building->location_province ?? '') }}">
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                    <div>
                                        ...
                                        <input type="text" name="latitude" id="latitude"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                            value="{{ old('latitude', $building->latitude ?? '') }}" readonly>
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" name="longitude" id="longitude"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                            value="{{ old('longitude', $building->longitude ?? '') }}" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="acquisition_mode" id="acquisition_mode"
                                        ...
                                        <option value="construction" {{ old('acquisition_mode', $building->acquisition_mode ?? '') === 'construction' ? 'selected' : '' }}>Construction</option>
                                        <option value="purchase" {{ old('acquisition_mode', $building->acquisition_mode ?? '') === 'purchase' ? 'selected' : '' }}>Purchase</option>
                                        <option value="donation" {{ old('acquisition_mode', $building->acquisition_mode ?? '') === 'donation' ? 'selected' : '' }}>Donation</option>
                                        <option value="transfer" {{ old('acquisition_mode', $building->acquisition_mode ?? '') === 'transfer' ? 'selected' : '' }}>Transfer</option>
                                        <option value="other" {{ old('acquisition_mode', $building->acquisition_mode ?? '') === 'other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="acquisition_date" id="acquisition_date"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('acquisition_date', $building->acquisition_date?->format('Y-m-d') ?? '') }}">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="estimated_fund" id="estimated_fund" step="0.01" min="0"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('estimated_fund', $building->estimated_fund ?? '') }}">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="completed_at" id="completed_at"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('completed_at', $building->completed_at?->format('Y-m-d') ?? '') }}">
                                    @error('completed_at')
                                        <p class="text-red-500 text-sm mt-2"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="registered_name" id="registered_name"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('registered_name', $building->registered_name ?? '') }}">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="land_ownership_status" id="land_ownership_status"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                        value="{{ old('land_ownership_status', $building->land_ownership_status ?? '') }}">
