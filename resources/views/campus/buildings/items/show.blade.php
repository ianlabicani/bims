    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-4">
                ...
                <span>/</span>
                <a href="{{ route('campus.buildings.items.index', $item->building) }}" class="hover:text-blue-600">Items</a>
                <span>/</span>
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('campus.buildings.items.edit', [$item->building, $item]) }}"
                    ...
                    <a href="{{ route('campus.buildings.items.index', $item->building) }}"
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900">
                                    @if($item->room)
                                        <a href="{{ route('campus.buildings.rooms.show', [$item->building, $item->room]) }}"
                        ...
                        <div class="divide-y divide-gray-200">
                            @foreach($item->room->items->where('id', '!=', $item->id)->take(5) as $relatedItem)
                                <div class="p-4 hover:bg-gray-50">
                                    <a href="{{ route('campus.buildings.items.show', [$item->building, $relatedItem]) }}"
                                        class="block">
