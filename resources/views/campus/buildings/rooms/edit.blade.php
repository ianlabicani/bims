...
@section('campus-content')
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                                ...
                                <span id="status-description" class="text-yellow-600"><i class="fas fa-clock"></i></span>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            descriptionInput.addEventListener('input', () => updateStatus('status-description', descriptionInput.value));

            // Initial status check
            updateStatus('status-name', nameInput.value);
            updateStatus('status-description', descriptionInput.value);
        });
    </script>
@endsection
